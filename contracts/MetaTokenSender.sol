...
contract TokenSender {
    ...
    // Adding the nonce parameter here
    ...
    function transfer (
        ...
        // Make sure the signer is the person on whose behalf we are executing the transaction
        require(signer == sender, "Signature does not come from sender" );
        // Transfer tokens from sender signer to receipient.
